...
const page = () => {
  ...
  return (
    <>
<h1 className='bg-black text-white p-5 text-5xl font-bold text-center' > Welcome To Todo List</h1>
...
<button className='bg-black px-4 py-3 text-2xl text-white font-bold rounded'>ADD TASK</button>
</form>
